    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=300), blank=True, default=list, size=None, validators=[app.validators.validate_images_field])),
                ('amenities', models.JSONField(default=list, validators=[app.models.validate_amenities])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='app.location')),
            ],
        ),
        migrations.AddField(
