    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=300), blank=True, default=list, size=None, validators=[app.validators.validate_image_urls])),
